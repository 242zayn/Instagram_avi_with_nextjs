  ...
  return (
    <div>
         <form onSubmit={handleSubmit} className=' relative flex flex-col w-full flex-wrap md:flex-nowrap gap-4 pt-[100px] ' >
          <input required placeholder='Username, email address or mobile number' type="text" name="email" id="" className=' bg-white pl-[10px]  w-[95%] mx-auto h-[50px] rounded-lg border border-slate-400 text-[15px] ' value={formData.email}  onChange={handleInputChange} />
